...
function Create({ addNewTour, newTours }) {
  ...
  const createTourHendler = () => {
    let allTransport = [];
    allTransport.push(transportInfo)
    if(transportInfo2){
      allTransport.push(transportInfo2)
    }
    let tour = {
  ...
  return (
    <div className="create container">
      <h1 className="create-title"> Fill the form fields to add new tour </h1>
      <div className="booking-form">
        ...
        <div className="form-group">
          ...
          <input
            onChange={e => setArrivalCounty(e.target.value)}
            type="text"
            id="arrivalCounty"
            className="form-control"
            value={arrivalCounty}
            placeholder="enter arrival county"
          />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          <label htmlFor="mainImg">
            End main image link or download image from your computer
          </label>
          <input
        ...
        <div className="form-group">
          ...
          <input
            onChange={e => setArrOfimg(e.target.value)}
            type="text"
            id="arrOfimg"
            className="form-control"
            value={arrOfimg}
          ...
          <small id="emailHelp" className="form-text text-muted">
            you need to enter all links with using ',' and not using ' '*gap
          </small>
        </div>
        <div className="form-group">
          ...
          <div>
            ...
            <input
              type="number"
              onChange={e =>
                setTransportInfo({ ...transportInfo, price: +e.target.value })
              }
          ...
          <div>
            ...
            <input
              type="number"
              onChange={e =>
                setTransportInfo2({ ...transportInfo2, price: +e.target.value })
              }
              placeholder="price of tour"
            />
          </div>
