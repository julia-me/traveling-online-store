...
function Favourite({allUsers, removeFromFavourite, loginUser}) {
      ...
      <div className=" favourite container">
       {favArr.length ? <h1> Your favourite tours </h1> : <h1> Your dont have favourite tours yet </h1>}
        ...
        {favArr.map(tour => {
            ...
            return(
                <div key={tour.arrivalCountry+ tour.arrivalCity} className="col-6 col-md-4 tour-card-wrapper">
                    <div className='favourite-item '>
                        <div className='favourite-item-delete'>
                            <svg onClick={(e)=> removeFromFavourite(tour.id)} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" className="svg-inline--fa fa-trash fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M432 32H312l-9.4-18.7A24 24 0 0 0 281.1 0H166.8a23.72 23.72 0 0 0-21.4 13.3L136 32H16A16 16 0 0 0 0 48v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16zM53.2 467a48 48 0 0 0 47.9 45h245.8a48 48 0 0 0 47.9-45L416 128H32z"></path></svg>
                        </div>
                        ...
                        <p>  {(new Date (end) - new Date (start)) /(24*60*60*1000)} days tour </p>
                        <p> tour for {tour.numberOfTrevellers}  person</p>
                        <div className="tour-item-back-more">
                            <Link onClick={(e)=> localStorage.setItem('Tour', JSON.stringify(tour))} to={{pathname: `/tour/${tour.id}`}}>
  ...
  export default connect(mapStateToProps, matchDispatchToProps)(Favourite);